    ...
    <div className='p-4'>
      ...
      < div className='flex flex-col border-2 border-sky-400 rounded-xl w-[600px] p-4 mx-auto'>
        ...
        <form className='my-4' onSubmit={patientRegister}>
          ...
          <label className='text-xl mr-4 text-gray-500'>Primary Caregiver (Emergency Contact) Email</label>
          <input
            type='email'
          ...
          <label className='text-xl mr-4 text-gray-500'>Primary Caregiver (Emergency Contact) Name</label>
          <input
            type='text'
            placeholder='Enter name'
            value={data.prim_emergency_contact}
            onChange={(e) => setData({ ...data, prim_emergency_contact: e.target.value })}
            className='border-2 border-gray-500 px-4 py-2 w-full'
          />

          <label className='text-xl mr-4 text-gray-500'>Primary Caregiver (Emergency Contact) Cell Phone Number</label>
          <input
            type='text'
          ...
          <label className='text-xl mr-4 text-gray-500'>Primary Caregiver (Emergency Contact) Work Phone Number</label>
          <input
            type='text'
            placeholder='Enter Phone Number'
          ...
          <label className='text-xl mr-4 text-gray-500'>Primary Caregiver (Emergency Contact) Relation to Patient</label>
          <input
            type='text'
            placeholder='Enter Relation'
            value={data.prim_ec_relationship}
            onChange={(e) => setData({ ...data, prim_ec_relationship: e.target.value })}
            className='border-2 border-gray-500 px-4 py-2 w-full'
          />

          <label className='text-xl mr-4 text-gray-500'>Secondary Caregiver Name</label>
          <input
            type='text'
            placeholder='Enter Name'
            value={data.sec_emergency_contact}
            onChange={(e) => setData({ ...data, sec_emergency_contact: e.target.value })}
            className='border-2 border-gray-500 px-4 py-2 w-full'
          />

          <label className='text-xl mr-4 text-gray-500'>Secondary Caregiver Cell Phone Number</label>
          <input
            type='text'
            placeholder='Enter Phone Number'
          ...
          <label className='text-xl mr-4 text-gray-500'>Secondary Caregiver Work Phone Number</label>
          <input
            type='text'
            placeholder='Enter Phone Number'
          ...
          <label className='text-xl mr-4 text-gray-500'>Secondary Caregiver Relation to Patient</label>
          <input
            type='text'
            placeholder='Enter Relation'
