    ...
    <>
      ...
      <div className="p-9 bg-white">
        ...
        { loading ? (
          ...
          <div>
            <EditPatient pat_email={pat_email} doctor_email={doctor_email} changeToFalse={changeToFalse} />
          </div>
        ) : patient ? (
          <div>
            <div
                ...
                <div className="border border-sky-400 rounded-xl p-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p>
                      ...
                      {patient.prim_ec_cell}
                    </p>
                    <p>
                      <span className="font-semibold">Work Phone:</span>{" "}
                      {patient.prim_ec_work}
                    </p>
                    <p>
                      <span className="font-semibold">Relation:</span>{" "}
                      {patient.prim_ec_relationship}
                    </p>
                  </div>
                </div>
                ...
                <div className="border border-sky-400 rounded-xl p-4">
                  ...
                  {doctor_email == "Yes" ? (
                    <p className="text-center text-gray-600">
                      This patient has been archived. Provider information is no longer
                      available.
                    </p>
                  ) : (
                    <div>
                  ...
                  {patient.yz_meds && patient.yz_meds.length > 0 && (
                    <div className="border border-yellow-600 rounded-md">
                      ...
                      <table className="w-full">
                        <tbody>
                          <tr>
                            <td className="p-3 border-b border-r border-t border-yellow-600 text-center">
                              Peak Flow Max: {patient.yz_peak_flow_max}
                            </td>
                            <td className="p-3 border-b border-t border-yellow-600 text-center">
