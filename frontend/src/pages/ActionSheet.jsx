            ...
            {loading ? (
              ...
              <>
                <div className='items-center justify-center'>
                  <div className='p-2 justify-center mx-auto' style={{ width: '85%', display: 'flex', flexDirection: 'row' }}>
                    <div >
                      <img src={asthma_logo} alt="Asthma Logo" style={{ width: '200px', height: 'auto' }} />
                    </div>
